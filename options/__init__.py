...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--continue_train", type=util.str2bool, default=False, help="resume training from last checkpoint"
        )
        parser.add_argument(
            "--pretrained_name", type=str, default=None, help="Load weights from the checkpoint of another experiment"
        )
